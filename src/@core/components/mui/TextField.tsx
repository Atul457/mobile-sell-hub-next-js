...
const TextFieldStyled = styled(TextField)<ITextFieldStyledProps>(({ theme, ...rest }) => ({
  ...
  '& .MuiInputBase-root': {
    ...
    alignItems: rest.label === null ? 'center' : 'flex-end',
    color: 'var(--mui-palette-primary-main) !important',
    backgroundColor: `${rest.type === 'search' ? '#ECF4FF' : '#F8F8F8'} !important`,
    fontSize: rest.type === 'search' ? theme.typography.body2.fontSize : theme.typography.body1.fontSize,
    fontWeight: rest.type === 'search' ? 400 : 500,
    ...
    '& .MuiInputBase-input': {
      '&:not(textarea).MuiInputBase-inputSizeSmall': {
        padding: rest.type !== 'search' && rest.label !== null ? '26px 24px 10px 24px' : '14px 24px'
      }
    },
    '&.Mui-disabled': {
  ...
  '& .MuiInputAdornment-root': {
    height: 'fit-content',
    maxHeight: 'unset',
    padding: theme.spacing(0, 2, rest.type !== 'search' && rest.label !== null ? 2 : 0, 0),
  ...
  '& .MuiInputBase-sizeSmall.MuiInputBase-adornedStart': {
    ...
    ...((rest.type === 'search' || rest.label === null) && {
      alignItems: 'center'
    })
  },
  ...
  '& .MuiSelect-select.MuiInputBase-inputSizeSmall, & .MuiNativeSelect-select.MuiInputBase-inputSizeSmall': {
    '& ~ i, & ~ svg': {
      inlineSize: '1.125rem',
      blockSize: '1.125rem',
      bottom: rest.label ? theme.spacing(3) : '16px',
      color: 'var(--mui-palette-customColors-textGray40)'
    },
    ...(!rest.value &&
      (rest.defaultValue ? rest.value === rest.defaultValue : true) && {
