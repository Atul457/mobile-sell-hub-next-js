      ...
      <Box position='relative' height='fit-content'>
        ...
        >
          {props.loading ? (
            ...
            <CommonImage
              src={props.src ?? (!props.isProfile ? utils.CONST.USER.DEFAULT_PROFILE_PICTURE : null)}
              width={200}
        ...
        {!props.loading ? (
          <div
            ...
            className='absolute right-0 bottom-0 w-[26px] h-[26px] md:w-[30px] md:h-[30px] bg-white shadow-xl rounded-full p-1.5 cursor-pointer hover:bottom-[2px] icon-transtion flex justify-center items-center'
          >
            {props.src ? (
              <svg
