...
let shopModules: IRolePermission['module'][] = ['category', 'tags', 'products'];
...
const ManageRoleModal = () => {
    ...
    const forShopOwner = manageRoles?.type === utils.CONST.ROLE.TYPES.SHOP;
    ...
    useEffect(() => {
        ...
        if (manageRoles_) {
            ...
            let permissionsObj = {};
            const markDefault = (
                role.type === utils.CONST.ROLE.TYPES.SHOP ? role.defaultShopRole : role.defaultAdminRole
            )
                ? 1
                : 0;
    ...
    }, [watch(), forShopOwner, setSelectAll]);
                        ...
                        <Controller
                            ...
                            render={({ field }) => {
                                return (
                                    ...
                                    >
                                        <MenuItem value={BOOLEAN_STATUS.NO}>
                                            {NUMERIC_BOOLEAN_STATUS[BOOLEAN_STATUS.NO]}
                                        </MenuItem>
                                        <MenuItem value={BOOLEAN_STATUS.YES}>
                                            {NUMERIC_BOOLEAN_STATUS[BOOLEAN_STATUS.YES]}
                                        </MenuItem>
                                    </CustomTextField>
                                );
                            }}
