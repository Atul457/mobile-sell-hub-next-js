...
export default function MultiStepStoreSignupMultiStepStoreSignup() {
  ...
  if(sucessSecton){
    return(
      <Box>
        <Typography fontSize={20} sx={{mb:4}}>Thank you for registering your shop with 73 Inc.</Typography>
        <Typography>Your account is currently in a pending state. Our team will contact you soon via your registered mobile number or email to verify your details and complete the setup process.</Typography>
      </Box>
    )
  }
